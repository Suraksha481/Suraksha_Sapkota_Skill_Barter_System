...
Route::get('/terms-of-use', [PageController::class , 'terms'])->name('terms-of-use');
...
Route::middleware(['auth'])->group(function () {
     ...
     */
        ...
        // Dispute filing (students)
        Route::get('/requests/{id}/dispute', [\App\Http\Controllers\DisputeController::class, 'create'])->name('disputes.create');
        Route::post('/requests/{id}/dispute', [\App\Http\Controllers\DisputeController::class, 'store'])->name('disputes.store');
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
            ...
            // Dispute management
            Route::get('/disputes', [\App\Http\Controllers\AdminController::class , 'disputes'])->name('admin.disputes');
            Route::post('/disputes/{id}/resolve', [\App\Http\Controllers\AdminController::class , 'resolveDispute'])->name('admin.disputes.resolve');
